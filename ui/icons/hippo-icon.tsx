...
import HippoSVG from "./hippo-icon.svg";

export function HippoIcon({ style }: any) {
  return (
...
export function HippoIcon2() {
  return (
    <HippoSVG
      style={{ height: "100px", stroke: "#ac1a22", strokeWidth: "10px" }}
    />
  );
}

export const HippoIcon3 = styled(HippoSVG)`
  height: 100px;
  stroke: #f0efda;
  stroke-width: 10px;
`;
